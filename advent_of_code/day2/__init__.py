...
input_values = """Game 1: 10 green, 5 blue; 1 red, 9 green, 10 blue; 5 blue, 6 green, 2 red; 7 green, 9 blue, 1 red; 2 red, 10 blue, 10 green; 7 blue, 1 red
...
Game 100: 15 blue, 6 red; 1 green, 2 red; 12 blue, 8 green, 1 red; 1 red, 7 blue""".split("\n")

def extract_named_values(game_strs: Iterable[str]):
    for game_str in game_strs:
        game_name, config = game_str.split(": ")
        _, game_num = game_name.split(" ")
        for config_str in config.split("; "):
            for config_colors in config_str.split(', '):
                color_count, color_name = config_colors.split(" ")
                yield int(game_num), color_name, int(color_count)