...
from advent_of_code.day1 import extract_first_and_last_numeric_value_as_int
...
def execute():
    values=[extract_first_and_last_numeric_value_as_int(i) for i in input_values]

    combined = list(zip(input_values, values))
