...
input_value=""".....180.........230..........................218.....189......415.......................322....507..................206..............111...
...
CHOP_PATTERN = re.compile(r"[0-9]+|[-*/!@#$%^&()+=]")
def chop_it_up(input: str) -> Dict[int, Dict[int, str]]:
    result = {}
    row = 0
    for line in input.split('\n'):
        match = None
        while True:
            match = CHOP_PATTERN.search(line, match.end(0) if match else 0)
            if not match:
                break
            start = match.start(0)
            val = match.group(0)
